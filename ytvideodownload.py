...
#The function to show all the resolutions and let the user select one
def getResolution():
    ...
    wn = Tk()
    wn.title("Youtube Video Downloader")
    wn.geometry('700x500')
    wn.config(bg='honeydew2')

    # Heading label
    Label(wn, text="Youtube Video Downloader", font=('Courier', 15), fg='grey19').place(x=100,y=15)
